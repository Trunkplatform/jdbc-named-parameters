...
public class NamedParameterPreparedStatement extends DelegatingPreparedStatement {
    ...
    static class ParseResult {
        ...
        public String toString() {
            ...
            sb.append("orderedParameters=[").append(String.join(",", orderedParameters));
    ...
    public static NamedParameterPreparedStatement from(Connection conn, String sql) throws SQLException {
    ...
    public static NamedParameterPreparedStatement from(Connection conn, String sql,
    ...
    public boolean execute(String sql) throws SQLException {
        return addSqlToException(() -> super.execute(sql));
    }

    @Override
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        return addSqlToException(() -> super.execute(sql, autoGeneratedKeys));
    }

    @Override
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        return addSqlToException(() -> super.execute(sql, columnIndexes));
    }

    @Override
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        return addSqlToException(() -> super.execute(sql, columnNames));
    }

    @Override
    public int[] executeBatch() throws SQLException {
        return addSqlToException(() -> super.executeBatch());
    }

    @Override
    public ResultSet executeQuery() throws SQLException {
        return addSqlToException(() -> super.executeQuery());
    }

    @Override
    public ResultSet executeQuery(String sql) throws SQLException {
        return addSqlToException(() -> super.executeQuery(sql));
    }

    @Override
    public int executeUpdate() throws SQLException {
        return addSqlToException(() -> super.executeUpdate());
    }

    @Override
    public int executeUpdate(String sql) throws SQLException {
        return addSqlToException(() -> super.executeUpdate(sql));
    }

    @Override
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return addSqlToException(() -> super.executeUpdate(sql, autoGeneratedKeys));
    }

    @Override
    public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return addSqlToException(() -> super.executeUpdate(sql, columnIndexes));
    }

    @Override
    public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        return addSqlToException(() -> super.executeUpdate(sql, columnNames));
    }

    private <T> T addSqlToException(ExecSql<T> f) throws SQLException {
        try {
            return f.call();
        } catch (SQLException e) {
            throw new SQLException("Error with query `" + parseResult.sql + "` and parameters " + parseResult.orderedParameters, e);
        }
    }

    private interface ExecSql<T> {
    ...
    public boolean hasNamedParameters() {
        return !parseResult.orderedParameters.isEmpty();
    }

    private Collection<Integer> getParameterIndexes(String parameter) {
        Collection<Integer> indexes = new ArrayList<>();
        for (int i = 0; i < parseResult.orderedParameters.size(); i++) {
            if (parseResult.orderedParameters.get(i).equals(parameter)) {
    ...
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("NamedParameterPreparedStatement{");
        sb.append("parseResult=").append(parseResult);
        sb.append('}');
        return sb.toString();
    }
}
